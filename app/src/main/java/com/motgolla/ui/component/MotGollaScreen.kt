...
sealed class MotGollaScreen(
    ...
    object Splash : MotGollaScreen("splash", "", showTopBar = false, showBottomBar = false, showBackButton = false)
    object Login : MotGollaScreen("login", "", showTopBar = false, showBottomBar = false, showBackButton = false)
    object SignUp : MotGollaScreen("signup", "", showTopBar = false, showBottomBar = false, showBackButton = false)
    object Welcome : MotGollaScreen("welcome", "", showTopBar = false, showBottomBar = false, showBackButton = false)
    object VoteProductSelect : MotGollaScreen("vote/productSelect", "투표 상품 선택", showBottomBar = false)
    object VoteTitleInput : MotGollaScreen("vote/titleInput", "투표 제목 입력", showBottomBar = false)
    object WebView : MotGollaScreen("webview", "", showTopBar = false, showBottomBar = false, showBackButton = true)
